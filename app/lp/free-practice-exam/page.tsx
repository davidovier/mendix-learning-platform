...
export const metadata: Metadata = {
  ...
  description:
    "Practice for your Mendix Intermediate Certification with 262 free exam questions. Instant feedback, progress tracking, and AI explanations.",
  robots: {
    index: true,
    follow: true,
  },
      ...
      <section className="flex-1 flex items-center justify-center px-4 py-16 sm:py-24">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-xl mx-auto">
            262 exam-style questions to help you pass the Mendix Intermediate
