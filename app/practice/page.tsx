...
export const metadata: Metadata = {
  title: "Practice Quiz - 262 Mendix Exam Questions",
  description:
    "Test your knowledge with 262 real exam-style questions. Free practice for Mendix Intermediate certification with instant feedback and progress tracking.",
  keywords: [
