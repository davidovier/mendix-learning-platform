...
export const metadata: Metadata = {
  title: "Practice Quiz - 391 Mendix Exam Questions",
  description:
    "Test your knowledge with 391 real exam-style questions. Free practice for Mendix Intermediate certification with instant feedback and progress tracking.",
  keywords: [
